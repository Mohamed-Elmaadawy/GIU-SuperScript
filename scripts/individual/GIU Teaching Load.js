...
// @match       https://portal.giu-uni.de/GIUb/INTStaff/SearchAcademicScheduled_001_m.aspx
// @namespace   Cyn0
// @version     1.1.4
...
(function () {
    ...
    if (isSchedulePage()) autoFillSchedulePage();
    else setTimeout(boot, HOME_BOOT_DELAY_MS);
