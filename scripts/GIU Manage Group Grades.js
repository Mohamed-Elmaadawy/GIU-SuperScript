...
function injectGradeStyles() {
    ...
    style.textContent = `
        ...
        .gmgg-stats {
            ...
            padding-top: 12px;
            animation: giusMGGFadeIn 0.35s ease;
        }
        .gmgg-stats-label {
            font-size: 10.5px;
            font-weight: 700;
...
function renderStats(body) {
    ...
    el.innerHTML = `
        <div class="gmgg-stats-label">Grade Statistics (${stats.count} students)</div>
        <div class="gmgg-stats-grid">
            <div class="gmgg-stat-item">
                <span class="gmgg-stat-val">${stats.min}</span>
                <span class="gmgg-stat-key">Min</span>
            </div>
            <div class="gmgg-stat-item">
                <span class="gmgg-stat-val">${stats.max}</span>
                <span class="gmgg-stat-key">Max</span>
            </div>
            <div class="gmgg-stat-item">
                <span class="gmgg-stat-val">${stats.avg}</span>
                <span class="gmgg-stat-key">Avg</span>
            </div>
            <div class="gmgg-stat-item">
                <span class="gmgg-stat-val">${stats.range}</span>
                <span class="gmgg-stat-key">Range</span>
            </div>
        </div>
    `;
    body.appendChild(el);
