...
(function () {
    ...
    // (notEnteredSessions belongs here too once that module merges in.)
    const NETWORK_ONLY_FEATURES = new Set(['studentAttendance', 'manageGroupGrades']);
    ...
    function renderHomeFeatureToggles() {
        ...
        Shared.injectStyle('gius-feature-toggle-styles', `
            ...
            .gius-feature-label-wrap{display:inline-flex;align-items:center;gap:6px;}
