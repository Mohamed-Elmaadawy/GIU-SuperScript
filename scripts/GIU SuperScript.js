    ...
    const Features = {
        staffAttendance(S) {
            ...
            function buildDayOffNoteForHome(summary) {
                ...
                let cls = "";
                let html = "";
                if (summary && summary.dayOffWarn && !isDayOffConfigured()) {
                    cls = "warn";
            ...
            function renderHomeWidget(summary, opts) {
                ...
                // Gate on LIVE config (not the cached dayOffWarn) so the note/greying clear
                // immediately once a day off is set, even before the cache is refreshed.
                if (summary && summary.dayOffWarn && !isDayOffConfigured()) {
