        ...
        proctorAggregator(S) {
            ...
            function injectStyles() {
                ...
                s.textContent = `
                    ...
                    /* Entry trigger — script-styled, override-proof against portal button CSS */
                    #gius-proctor-trigger {
                        margin: 10px 0 0 !important;
                        height: 34px !important; padding: 0 16px !important;
                        display: inline-flex !important; align-items: center; gap: 7px;
                        background: #1B59C6 !important; color: #fff !important;
                        border: 1px solid #1648a8 !important; border-radius: 6px !important;
                    ...
                    #gius-proctor-trigger:hover { background: #1648a8 !important; }
                    ...
                    html.gius-dark #gius-proctor-trigger {
                        background: #1B59C6 !important; border-color: #1648a8 !important;
                    }
