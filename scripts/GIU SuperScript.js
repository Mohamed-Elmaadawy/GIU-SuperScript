        ...
        proctorAggregator(S) {
            ...
            function injectStyles() {
                ...
                s.textContent = `
                    ...
                    /* Entry trigger — GIU gold, override-proof against portal button CSS */
                    #gius-proctor-trigger {
                        margin: 10px 0 0 !important;
                        height: 34px !important; padding: 0 16px !important;
                        display: inline-flex !important; align-items: center; gap: 7px;
                        background: #ffc107 !important; color: #272c33 !important;
                        border: 1px solid #e0a800 !important; border-radius: 6px !important;
                    ...
                    #gius-proctor-trigger:hover { background: #e0a800 !important; }
                    #gius-proctor-trigger:active { transform: translateY(1px); }
                    #gius-proctor-trigger .fa { color: #272c33 !important; }
                    #gius-proctor-trigger.gius-hide { display: none !important; }
                    html.gius-dark #gius-proctor-trigger {
                        background: #ffc107 !important; color: #272c33 !important; border-color: #e0a800 !important;
                    }
                    html.gius-dark #gius-proctor-trigger .fa { color: #272c33 !important; }
