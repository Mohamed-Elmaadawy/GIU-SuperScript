    ...
    function render(sessions, opts = {}) {
        ...
        const nextHtml = `
            <div id="gius-pr-next" class="gius-pr-next">
                ...
                <button type="button" id="gius-pr-ics-all" class="gius-pr-act gius-btn gius-pr-act-all" title="Download all upcoming as .ics">Download all</button>
            </div>`;
        ...
        const listHtml = remaining.length ? `
            <button type="button" id="gius-pr-toggle-all" class="gius-pr-toggle gius-btn" aria-expanded="false" aria-controls="gius-pr-all">Remaining exams (${remaining.length})</button>
