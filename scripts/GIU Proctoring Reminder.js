...
(function () {
    ...
    function render(sessions, opts = {}) {
        ...
        const metaLine = s => `${s.examName}${s.type === 'Supervisor' ? ` · Control Room ${s.controlRoom}` : ''}`;
                    ...
                    <div class="gius-pr-all">
                        ${remaining.map(s => `
                            <div class="gius-pr-row" data-idx="${upcoming.indexOf(s)}">
                                ...
                                <div class="gius-pr-meta">${s.examName}</div>
                                <div class="gius-pr-actions"></div>
                            </div>`).join('')}
                    </div>
                </div>
    ...
    function injectStyles() {
        ...
        const css = `
            ...
            .gius-pr-row-time{font-size:14px;font-weight:700;color:#3730a3;margin:2px 0 4px;}
